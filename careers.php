...
<body>
    ...
    <section class="careerHero container">
        <div class="row">
            <div class="careerHero__title col-12 col-lg-8 offset-lg-2" data-aos="fade" data-aos-delay="100">
    ...
    <section class="benefits container">
        <div class="row">
        <div class="benefits__title col-12 col-lg-8 offset-lg-2" data-aos="fade" data-aos-delay="100">
        ...
        <div class="benefits__cards col-12" data-aos="fade" data-aos-delay="150">
        ...
        <div class="benefits__cards col-12" data-aos="fade" data-aos-delay="200">
            <div class="benefits__item">
    ...
    <section class="openJobs container">
        <div class="row">
            <div class="openJobs__title col-12" data-aos="fade" data-aos-delay="100">
