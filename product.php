                    ...
                    <div class="product__swiperContainer col-12 col-lg-6" data-aos="fade" data-aos-delay="100">
                        <div class="swiper mySwiper2 product__swiper2">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide"><img src="./src/assets/product-2.jpg" alt=""></div>
                                <div class="swiper-slide"><img src="./src/assets/product-3.jpg" alt=""></div>
                                <div class="swiper-slide"><img src="./src/assets/product-4.jpg" alt=""></div>
                            </div>
                        </div>
                        <div class="swiper mySwiper product__swiper">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide product__smallSlide"><img src="./src/assets/smallProduct-1.jpg"
                                        alt=""></div>
                                <div class="swiper-slide product__smallSlide"><img src="./src/assets/smallProduct-2.jpg"
                                        alt=""></div>
                                <div class="swiper-slide product__smallSlide"><img src="./src/assets/smallProduct-3.jpg"
                                        alt=""></div>
                                <div class="swiper-slide product__smallSlide"><img src="./src/assets/smallProduct-4.jpg"
                                        alt=""></div>
                            </div>
                        </div>
                    </div>
