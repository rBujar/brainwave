                ...
                <div class="row">
                    ...
                    <div class="product__info col-12 col-lg-5 offset-lg-1" data-aos="fade" data-aos-delay="150">
                        ...
                        <div class="product__price">
                            <p class="text-md">List Price: $549</p>
                            <h4>Price: <span>$479</span></h4>
                        </div>
                        <ul class="product__list">
                            <li>
                                <p class="text-sm">Active Noise Cancellation for immersive, high-fidelity sound</p>
                            </li>
                            <li>
                                <p class="text-sm">Transparency mode to hear and interact with the world around you</p>
                            </li>
                            <li>
                                <p class="text-sm">Custom acoustic design with Apple-engineered drivers</p>
                            </li>
                            <li>
                                <p class="text-sm">Spatial audio with dynamic head tracking for theater-like sound</p>
                            </li>
                        </ul>
