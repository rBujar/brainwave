                ...
                <div class="grid grid-cols-12">
                        ...
                        <div class="swiper mySwiper product__swiper mt-2 md:order-1 md:mt-0 md:max-h-[310px] md:min-w-[70px]">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide product__smallSlide group"><img
                                        ...
                                        src="./src/assets/product/miniShoe-1.jpg" alt=""></div>
                                <div class="swiper-slide product__smallSlide group"><img
                                        class="group-[.swiper-slide-thumb-active]:border group-[.swiper-slide-thumb-active]:border-general-black rounded-[10px]"
                                        src="./src/assets/product/miniShoe-2.jpg" alt=""></div>
                                <div class="swiper-slide product__smallSlide group"><img
                                        class="group-[.swiper-slide-thumb-active]:border group-[.swiper-slide-thumb-active]:border-general-black rounded-[10px]"
                                        src="./src/assets/product/miniShoe-3.jpg" alt=""></div>
                                <div class="swiper-slide product__smallSlide group"><img
                                        class="group-[.swiper-slide-thumb-active]:border group-[.swiper-slide-thumb-active]:border-general-black rounded-[10px]"
                                        src="./src/assets/product/miniShoe-4.jpg" alt=""></div>
                            </div>
                        </div>
                    </div>
                    <div class="product__info col-span-12 lg:col-span-5 lg:col-start-8 flex flex-col items-start justify-center"
                        ...
                        <div class="product__name mb-4">
                            <h3 class="text-4xl mb-2">Turquoise Suede Monk Strap Brogue Dress Shoes</h3>
                            <p class="text-lg">by <a
                                    class="text-primary-blue transition-colors duration-200 ease-in-out [&:hover]:bg-primary-hoverBlue"
                                    href="#">Classic Leather Co.</a></p>
                        </div>
                        <div class="product__price mb-4">
                            <p class="text-lg mb-2 text-[#7d818d]">List Price: $120</p>
                            <h4 class="text-[#7d818d]">Price: <span class="text-general-black">$85</span></h4>
                        </div>
                        <ul class="product__list !pl-5 mb-7 [&>li]:list-disc </div>  [&>li]:mb-2">
                            <li>
                                <p class="text-md">Premium suede upper for a soft and elegant finish</p>
                            </li>
                            <li>
                                <p class="text-md">Classic monk strap closure for a secure and stylish fit</p>
                            </li>
                            <li>
                                <p class="text-md">Decorative brogue perforations for a refined look</p>
                            </li>
                            <li>
                                <p class="text-md">Durable leather sole designed for comfort and long-lasting wear</p>
                            </li>
                        </ul>
